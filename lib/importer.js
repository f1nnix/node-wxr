(function() {
  ...
  module.exports = Importer = (function() {
    ...
    Importer.prototype.addPost = function(post) {
      var cat, catCDATA, category, contentEncoded, contentEncodedCDATA, creator, date, description, excerptEncoded, excerptEncodedCDATA, i, id, item, len, name, parent, ref, ref1, results, status, title, type;
    ...
    Importer.prototype.addAttachment = function(options) {
      var creator, date, description, excerptEncoded, excerptEncodedCDATA, id, item, parent, status, title, type;
